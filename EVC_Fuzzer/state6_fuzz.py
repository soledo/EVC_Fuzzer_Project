"""
ChargeParameterDiscoveryRequest 메시지를 가지고 퍼징을 수행하는 코드입니다. 
타겟 상태머신 : Wait for ChargeParameterDiscoveryRequest
"""
...
class _TCPHandler:
    def __init__(self, pev: PEV, iterations_per_element):
        ...
        self.service_payment_selection_response_received = Event()  # 새로운 이벤트
        self.contract_authentication_response_received = Event()     # 새로운 이벤트
    ...
    def send_fuzzing_messages(self):
        # 초기 XML 메시지 빌드 (ChargeParameterDiscoveryRequest 사용)
        handler = PacketHandler()
