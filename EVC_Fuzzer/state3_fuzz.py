"""
ServiceDiscoveryRequest 메시지를 가지고 퍼징을 수행하는 코드입니다. 
타겟 상태머신 : Wait for ServiceDiscoveryRequest
"""
...
class _TCPHandler:
    def __init__(self, pev: PEV, iterations_per_element):
        ...
        self.state = {}
        self.elements_to_modify = ["ServiceCategory"]  # 퍼징할 요소 목록
    ...
    def send_fuzzing_messages(self):
        # 초기 XML 메시지 빌드 (ServiceDiscoveryRequest 사용)
        handler = PacketHandler()
