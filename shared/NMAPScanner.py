...
class NMAPScanner():
    ...
    def getPortList(self):
        res = []
        import os
        # Try to find modportlist.txt in shared directory or current directory
        possible_paths = [
            os.path.join(os.path.dirname(__file__), "modportlist.txt"),
            "modportlist.txt"
        ]
        ...
        # If not found, use default common ports
        print("WARNING: modportlist.txt not found, using default ports")
